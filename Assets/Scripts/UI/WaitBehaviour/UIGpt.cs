...
namespace UI
{
    public class UIGpt : TVWaitBehaviour
    {
        ...
        private const string GPT_TEXT = "{0}은(는) 서울 디지텍 고등학교 설립부터 있던 학생입니다. {0}은(는) 천재적인 전략과 강력한 무력을 바탕으로 서울 디지텍 고등학교의 명성을 위해 500개가 넘는 학교를 재패하며 학교를 홍보하였습니다. 또한, {0}은(는) 프로젝트를 일부로 망트리길 좋아하는 엄의 기질을 가지고 있습니다. {0}의 엄 능력은 갑옷 엄인 김유찬 또한 경외할 정도입니다. {0}의 이야기는 오늘날에도 여전히 서울 디지텍 고등학교에서 전설로 전해지고 있습니다.";
        ...
        public override IEnumerator Wait() // GPT가 얘기하는동안 플레이어가 쉬지는 않음.
        {
